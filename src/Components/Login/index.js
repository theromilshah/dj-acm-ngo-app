...
clicker=()=>{
    ...
    render() { 
        return ( 
            <div id="lgbg">                   
                <Paper style={{margin:"5vw 16vw",paddingTop:"5vw",background:"rgba(255,255,255,0.6)",borderRadius:"20px",zIndex:"1",float: "left",marginBottom:"3vw",width:"65vw",height:"550px",overflow:"hidden"}} >
